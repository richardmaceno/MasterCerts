...
INSERT INTO funcionario VALUES (4, '', 1500.0);)
...
SELECT count_if(NAME IS NULL)  AS QTDE FROM funcionario

-- COMMAND ----------

DESCRIBE HISTORY  funcionario
...
DESCRIBE TABLE EXTENDED funcionario
